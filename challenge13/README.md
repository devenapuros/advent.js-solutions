# Challenge 13: Backup del Nopor de Papa Noel

## Problema

Para evitar perder todos sus videos nopor cuando el servidor se cae, Papa Noel ha decidido hacer backups incrementales. Un hacker llamado S4vitelf le esta ayudando.
